...
class DiffusionEmbedding(nn.Module):
    ...
    def forward(self, diffusion_step):
        if diffusion_step.dtype in [torch.int32, torch.int64]:
            x = self.embedding[diffusion_step] # ->[50, 128]
        else: # inference
...
class diff_CSDI(nn.Module):
    def __init__(self, params, inputdim=1):
        super().__init__()
        '''
        layers: 4
        channels: 64
        ...
        self.channels = params.residual_channels #64
        self.target_dim = params.n_features
        self.emb_time_dim = params.emb_time_dim # 128
        self.emb_feature_dim = params.emb_feature_dim # 16
        self.side_dim = self.emb_time_dim + self.emb_feature_dim
        self.diffusion_embedding_dim = params.diffusion_embedding_dim # 128
